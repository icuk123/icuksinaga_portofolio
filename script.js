...
function initContactForm() {
    ...
    form.addEventListener('submit', (e) => {
        ...
        // Send AJAX POST request to Web3Forms
        ...
        .then(async (response) => {
            ...
            if (response.status === 200) {
                ...
                alert(jsonResponse.message || 'Gagal mengirim pesan. Silakan coba kembali.');
            }
        })
        .catch(error => {
            console.error('Error:', error);
            alert('Terjadi kesalahan koneksi. Silakan coba lagi atau hubungi via email langsung.');
        })
        .then(() => {
            // Reset Button State
